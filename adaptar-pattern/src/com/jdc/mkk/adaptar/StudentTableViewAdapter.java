...
import com.jdc.mkk.component.TableView.DataModel;
import com.jdc.mkk.model.Student;
...
public class StudentTableViewAdapter implements DataModel {
	...
	public List<String> row(int index) {
		...
		return List.of(String.valueOf(student.getId()), student.getName(), student.getPhone(), student.getEmail());
	}
